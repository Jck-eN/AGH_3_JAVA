...
public class EvolutionMap extends AbstractWorldMap {
    ...
    private final Rectangle jungle = new Rectangle(
            new Vector2d((Config.EVOLUTION_MAP_WIDTH-Config.JUNGLE_WIDTH)/2,(Config.EVOLUTION_MAP_HEIGHT-Config.JUNGLE_HEIGHT)/2),
